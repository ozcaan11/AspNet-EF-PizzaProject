...
<asp:Content ID="Content3" ContentPlaceHolderID="cpBody" runat="server">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <img class="img-circle" src="dist/image/y_1.jpg" alt="Generic placeholder image" width="140" height="140" />
                        <h2>Heading</h2>
                    ...
                    <!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <img class="img-circle" src="dist/image/y_2.jpg" alt="Generic placeholder image" width="140" height="140" />
                        <h2>Heading</h2>
                    ...
                    <!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <img class="img-circle" src="dist/image/y_3.jpg" alt="Generic placeholder image" width="140" height="140" />
                        <h2>Heading</h2>
